  ...
  return (
    <div>
      ...
      <ol className="list-decimal list-inside space-y-2 text-muted-foreground mb-6">
        ...
        <li>Agent sends <code className="text-sm bg-code-bg px-1.5 py-0.5 rounded font-mono text-accent">REGISTER &lt;port&gt;</code></li>
      ...
      <ol className="list-decimal list-inside space-y-2 text-muted-foreground mb-6">
        <li>Public user connects to <code className="text-sm bg-code-bg px-1.5 py-0.5 rounded font-mono text-accent">SERVER_IP:PUBLIC_PORT</code></li>
        ...
        <li>Traffic flows bidirectionally</li>
      </ol>
