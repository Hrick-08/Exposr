  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-4 leading-relaxed">
        Data connections carry the actual traffic between public users and local services. Each incoming TCP connection, or UDP datagram session, gets a dedicated data tunnel through port <code className="text-sm bg-code-bg px-1.5 py-0.5 rounded font-mono text-accent">9001</code> on the relay server.
      </p>
      ...
      <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
        ...
        <li>When the public client disconnects, or the UDP session ends, the corresponding data connection is closed</li>
      </ul>
      <p className="text-muted-foreground mb-4 leading-relaxed">
      ...
      <ol className="list-decimal list-inside space-y-2 text-muted-foreground mb-4">
        <li>Server receives a public TCP connection or UDP datagram and generates a UUID</li>
        ...
        <li>TCP traffic flows as a stream; UDP payloads use length-prefixed frames over the TCP data connection</li>
      </ol>
