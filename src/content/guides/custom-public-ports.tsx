  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-4 leading-relaxed">
        Add the exact public port after the local port. Use the transport command that matches your service:
      </p>
...
exposr tcp 8080 25000

# Expose Minecraft on its default port
exposr tcp 25565 25565`}</CodeBlock>
